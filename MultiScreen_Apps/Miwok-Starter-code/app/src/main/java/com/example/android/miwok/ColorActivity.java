            ...
            new AudioManager.OnAudioFocusChangeListener()
            {
                ...
                public void onAudioFocusChange(int focusChange)
                {
                            ...
                            focusChange == AudioManager.AUDIOFOCUS_LOSS_TRANSIENT_CAN_DUCK)
                    {
                        ...
                        // short amount of time. he AUDIOFOCUS_LOSS_TRANSIENT_DUCK case means that
                        // our app is allowed to continue playing sound but at a lower volume. We'll treat
                        // bot cases the same way because our app is playing short sound files.
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener()
        {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long id)
            {
                ...
                if (result == AudioManager.AUDIOFOCUS_REQUEST_GRANTED)
                {
                    ...
                    mMediaPlayer = MediaPlayer.create(ColorActivity.this, word.getmAudioResouceId());
